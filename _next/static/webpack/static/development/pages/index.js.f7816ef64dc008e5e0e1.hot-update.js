...
function (_Component) {
  ...
  _createClass(Index, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                data = _context.sent;
                console.log(data, 'the data in fetch');
    ...
    value: function render() {
      var stocks = this.state.stocks; //console.log(stocks, 'the stocks')
...
//# sourceMappingURL=index.js.f7816ef64dc008e5e0e1.hot-update.js.map