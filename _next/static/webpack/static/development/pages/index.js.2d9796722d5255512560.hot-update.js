...
})(["position:relative;.input{font-size:15px;padding:5px;border:none;background:none;border-bottom:", ";color:#fff;font-weight:700;text-align:right;width:100px;transition:all 0.2s ease-in-out;::-webkit-input-placeholder{color:rgba(255,255,255,0.8);font-weight:300;}::-moz-placeholder{color:rgba(255,255,255,0.8);font-weight:300;}:-ms-input-placeholder{color:rgba(255,255,255,0.8);font-weight:300;}:-moz-placeholder{color:rgba(255,255,255,0.8);font-weight:300;}}"], function (props) {
...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderInputFields", function () {
      ...
      console.log(symbolList[0], 'the first symbol');
...
//# sourceMappingURL=index.js.2d9796722d5255512560.hot-update.js.map