...
function (_Component) {
  ...
  function Index() {
      ...
      if (clickedItem === "input") {
        ...
        _this.setState({
          timeout: setTimeout(function () {
            return _this.findMatch(selected, index);
          }, 100)
        });
      } else {
        selected = e;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clearMatches", function (i) {
      ...
      console.log(_this.state.timeout, 'the timeout');

      _this.setState(_defineProperty({}, "matches".concat(i), null), function () {
        return console.log(_this.state["matches".concat(i)], i, 'the cleared match');
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderInputFields", function () {
      ...
      return Array.from(new Array(4), function (val, i) {
        console.log(_this.state["matches".concat(i)], i, 'the matches in render input');
...
//# sourceMappingURL=index.js.282f189eee06ae095a3a.hot-update.js.map