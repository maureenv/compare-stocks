...
var descriptions = [{
  ...
  peRatio: 'The price-earnings ratio determines how much investors are willing to pay for a stock relative to the company’s earnings. It’s calculated by taking the current price of a stock and dividing it by the company’s earnings per share. A low P/E ratio means the stock is undervalued. Companies in new, quick-growing industries with lots of future potential tend to have lower P/E ratios. However, a low P/E ratio can also reflect a lack of growth potential.'
}, {
...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTableRow", function (title, category, subcategory, isDollar, isPercent) {
      var stocks = _this.state.stocks;
      var info = directions.filter(function (d) {
        return console.log(d, 'the direction');
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tr, {
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.b9c81831976c73d3553d.hot-update.js.map