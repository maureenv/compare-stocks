...
})([".input{opacity:0;}.input:checked + label{background:", ";}.label{background:", ";color:#fff;padding:5px;font-family:'Roboto',sans-serif;cursor:pointer;font-size:13px;border-radius:4px;width:30px;text-align:center;display:inline-block;}.input[type=\"radio\"]:focus + label::before{outline:rgb(59,153,252) auto 5px;}"], function (props) {
...
//# sourceMappingURL=index.js.c0f4ab7cd948f3dd33c3.hot-update.js.map