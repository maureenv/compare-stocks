  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "chartData", function (canvas) {
      ...
      if (stocks.length) {
        ...
        var gradient = ctx.createLinearGradient(180, 0, 1000, 20);
        gradient.addColorStop(0, 'rgba(103,255,255,0.4)');
        gradient.addColorStop(1, 'rgba(141,255,103,0)');
...
//# sourceMappingURL=index.js.9f552d6871e3f12d6013.hot-update.js.map