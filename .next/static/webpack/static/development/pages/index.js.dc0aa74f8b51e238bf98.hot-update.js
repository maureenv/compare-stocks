...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setSymbol", function (symbol, event) {
      var text = event.target.value;

      var symbolList = _toConsumableArray(_this.state.symbolList);

      console.log(s, 'the symbol', e.target.value, 'the ev');
    });
...
//# sourceMappingURL=index.js.dc0aa74f8b51e238bf98.hot-update.js.map