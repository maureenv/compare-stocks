...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submit", function () {
      ...
      var removeFromList = [undefined, empty, null, ''];
      console.log(symbolList, ' teh symbol list');
      symbolList.filter(function (i) {
        return !removeFromList.includes(i);
      });
      console.log(symbolList, 'after');
    });
...
//# sourceMappingURL=index.js.c2ee8637b39279537844.hot-update.js.map