  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "buildChartData", function (stocks) {
      ...
      stocks.map(function (s, i) {
        ...
        s.chart.map(function (c) {
          return data.push(c.close.toFixed(2));
        });
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                if (stocks.length > 0) {
                  ...
                  console.log(stocks, 'stocks in submit');
                }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setChartRange", function (range) {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        var symbolList, removeFromList, filteredList, res, data;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                console.log(filteredList, 'filtered list', range, 'the range');
                _context3.next = 8;
                return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()("https://api.iextrading.com/1.0/stock/market/batch?symbols=".concat(filteredList.join(","), "&chart&range=").concat(range));
...
//# sourceMappingURL=index.js.07c097495f0d6c12b554.hot-update.js.map