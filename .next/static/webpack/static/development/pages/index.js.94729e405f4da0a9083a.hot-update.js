  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submit", function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var symbolList, removeFromList, filteredList, res, data, stocks, array, chartLegend;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                if (stocks.length > 0) {
                  chartLegend = [];
                  stocks.map(function (s, i) {
                    return chartLegend[i].push(_defineProperty({}, "line".concat(i), false));
                  });
                  console.log(chartLgend, 'the chart legends');
...
//# sourceMappingURL=index.js.94729e405f4da0a9083a.hot-update.js.map