  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setChartRange", function (range) {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        var symbolList, removeFromList, filteredList, res, data, dataArray, stocks;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                console.log(stocks, 'the stocks'); // stocks.map( ( s, i ) => {
                //   const chartData = data.find( d => s.company.symbol )
...
//# sourceMappingURL=index.js.2f60a86fd96725fe61a0.hot-update.js.map