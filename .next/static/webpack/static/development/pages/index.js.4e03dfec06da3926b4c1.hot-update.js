...
})(["position:relative;.input{font-size:15px;padding:5px;border:none;background:none;border-bottom:1px solid #fff;color:#fff;font-weight:700;text-align:right;width:100px;transition:all 0.2s ease-in-out;::-webkit-input-placeholder{color:#fff;}::-moz-placeholder{color:#fff}:-ms-input-placeholder{color:#fff;}:-moz-placeholder{color:#fff;}}"]);
...
//# sourceMappingURL=index.js.4e03dfec06da3926b4c1.hot-update.js.map