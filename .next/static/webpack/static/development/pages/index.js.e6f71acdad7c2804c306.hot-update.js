...
})(["position:absolute;background:#fff;width:230px;padding:15px;border-radius:4px;.match{font-size:13px;padding:10px 0;border-bottom:1px solid #d6d6d6;display:flex;justify-content:space-between;&:last-child{border-bottom:0;}&:hover{background:#d6d6d6;}}.symbol{font-weight:500;}.company-name{max-width:150px;text-align:right;line-height:1.3;color:#767676;}"]);
...
//# sourceMappingURL=index.js.e6f71acdad7c2804c306.hot-update.js.map