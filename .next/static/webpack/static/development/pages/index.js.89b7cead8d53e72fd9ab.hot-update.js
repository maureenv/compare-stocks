...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submit", function () {
      ...
      var removeFromList = [undefined, null];
      var filtereddList = symbolList.filter(function (i) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()("https://api.iextrading.com/1.0/stock/market/batch?symbols=".concat(filteredList.split(","), "&types=quote,stats,financials,company,earnings,chart&range=3m"));
...
//# sourceMappingURL=index.js.89b7cead8d53e72fd9ab.hot-update.js.map