...
})(["text-align:", ";padding:10px 20px;border-bottom:1px solid #d6d6d6;"], function (props) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getValue", function (value) {
      if (typeof value === "string") {
        ...
        console.log(value, 'the value'); //return Math.floor( value * 100 ) / 100
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTableRow", function (title, category, subcategory, isDollar, isPercent) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tr, {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Th, {
          ...
          __self: this
        }, symbol, _this.getValue(s[category][subcategory]));
      }) : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Th, {
        colSpan: "4",
        __source: {
          fileName: _jsxFileName,
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(OuterContainer, {
        ...
        __self: this
      }, " Go ")), this.renderTableRow('Name', 'company', 'companyName', false, false), this.renderTableRow('Sector', 'company', 'sector', false, false), this.renderTableRow('Industry', 'company', 'industry', false, false), this.renderTableRow('Latest Price', 'quote', 'latestPrice', true, false), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tr, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 363
        },
...
//# sourceMappingURL=index.js.1d00ae7436cddb53b9a7.hot-update.js.map