  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submit", function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var symbolList, removeFromList, filteredList;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(filteredList.split(","), 'after'); // const res = await fetch(`https://api.iextrading.com/1.0/stock/market/batch?symbols=${ filteredList.split(",")}&types=quote,stats,financials,company,earnings,chart&range=3m`)
...
//# sourceMappingURL=index.js.cb74f4750f42296ac1e5.hot-update.js.map