...
})(["position:relative;.input{font-size:13px;padding:5px;border:none;background:none;border-bottom:1px solid #fff;color:#fff;text-align:right;width:80px;::-webkit-input-placeholder{color:#6f6f6f;}::-moz-placeholder{color:#6f6f6f;}:-ms-input-placeholder{color:#6f6f6f;}:-moz-placeholder{color:#6f6f6f;}}"]);
...
//# sourceMappingURL=index.js.bf7e691c0e0f70a5623d.hot-update.js.map