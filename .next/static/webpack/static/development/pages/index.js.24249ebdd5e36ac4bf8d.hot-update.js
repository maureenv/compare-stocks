...
})(["position:relative;.input{font-size:15px;padding:5px;border:none;background:none;border-bottom:1px solid #fff;color:#fff;font-weight:700;text-align:right;width:90px;transition:all 0.2s ease-in-out;::-webkit-input-placeholder{color:#6f6f6f;}::-moz-placeholder{color:#6f6f6f;}:-ms-input-placeholder{color:#6f6f6f;}:-moz-placeholder{color:#6f6f6f;}}"]);
...
//# sourceMappingURL=index.js.24249ebdd5e36ac4bf8d.hot-update.js.map