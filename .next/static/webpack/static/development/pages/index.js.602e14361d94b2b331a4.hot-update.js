...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleLine", function (i) {
      ...
      if (_this.refs.chart.chartInstance.getDatasetMeta(i).hidden = true) {
        _this.refs.chart.chartInstance.getDatasetMeta(i).hidden = null;
      } else {
        _this.refs.chart.chartInstance.getDatasetMeta(i).hidden = true;
      }
...
//# sourceMappingURL=index.js.602e14361d94b2b331a4.hot-update.js.map