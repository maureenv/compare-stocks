...
})(["position:relative;.input{font-size:14px;text-transform:capitalize;}"]);
...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderInputFields", function () {
      ...
      console.log(matches && matches[0]['1. symbol'], 'the first match');
      return Array.from(new Array(4), function (val, i) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Th, {
          ...
          __self: this
        }), _this.state["matches".concat(i)] && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 315
          },
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          ...
          chartData = _this$state2.chartData,
          chartOptions = _this$state2.chartOptions;
...
//# sourceMappingURL=index.js.284a26a3ec9d02105515.hot-update.js.map