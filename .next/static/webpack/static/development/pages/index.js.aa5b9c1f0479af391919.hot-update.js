...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "buildChartData", function (stocks) {
      ...
      var colors = ['#0d60bb', '#01a8d2', '#1dc7a3', '#0db106'];
      ...
      chartOptions.legendCallback = function (chart) {
        console.log(chart.data, 'the chart data');
      };
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(OuterContainer, {
        ...
        __self: this
      }, this.generateLegend()), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_6__["Line"], {
        data: chartData,
...
//# sourceMappingURL=index.js.aa5b9c1f0479af391919.hot-update.js.map