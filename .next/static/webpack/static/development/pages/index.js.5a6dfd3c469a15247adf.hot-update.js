...
})([".input{position:relative;z-index:-9999;}.input:checked + label{background:", ";}.label{background:gray;color:#fff;padding:5px;font-family:'Roboto',sans-serif;cursor:pointer;font-size:13px;border-radius:4px;width:30px;text-align:center;display:inline-block;}"], function (props) {
...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {// document.body.addEventListener( 'click', this.clearMatches )
...
//# sourceMappingURL=index.js.5a6dfd3c469a15247adf.hot-update.js.map