  ...
  function Index() {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                _this.setState({
                  ...
                  return console.log(_this.state.matches);
                });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderInputFields", function () {
      ...
      return Array.from(new Array(4), function (val, i) {
        console.log(_this.state.symbolList[i], 'teh symbol list');
...
//# sourceMappingURL=index.js.2a0b6b5d7c5612efcf48.hot-update.js.map