...
})(["background:#f5f5f5;width:100%;height:100%;border-radius:4px;max-width:1200px;display:flex;align-items:center;justify-content:center;margin:40px;.particles-class{width:100%;height:100%;min-height:100vh;position:absolute;top:0;z-index:-1;position:fixed;}"]);
...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clearMatches", function (i) {
      _this.setState(_defineProperty({}, "matches".concat(i), null), function () {
        return console.log(_this.state["matches".concat(i)], 'the cleared match');
      });
    });
...
//# sourceMappingURL=index.js.3015e32ddb666f80e886.hot-update.js.map