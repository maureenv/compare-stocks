...
})(["with:10px;height:10px;border-radius:10px;background-color:", ";"], function (props) {
  return props.color;
});
...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "buildChartData", function (stocks) {
      ...
      stocks.map(function (s, i) {
        ...
        chartData.datasets.push({
          ...
          pointBorderWidth: 1,
          pointHoverRadius: 5,
          pointHoverBackgroundColor: charcColors[i],
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderLegend", function () {
      ...
      stocks.length && stocks.map(function (s, i) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 353
...
//# sourceMappingURL=index.js.b12ffe84ca80ab81de21.hot-update.js.map