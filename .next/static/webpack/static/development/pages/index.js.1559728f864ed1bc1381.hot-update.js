          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(filteredList.join(","), 'after'); // const res = await fetch(`https://api.iextrading.com/1.0/stock/market/batch?symbols=${ filteredList.split(",")}&types=quote,stats,financials,company,earnings,chart&range=3m`)
...
//# sourceMappingURL=index.js.1559728f864ed1bc1381.hot-update.js.map