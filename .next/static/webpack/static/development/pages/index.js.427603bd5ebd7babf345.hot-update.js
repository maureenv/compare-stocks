...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleLine", function (i) {
      ...
      _this.refs.chart.chartInstance.getDatasetMeta(i).hidden = _this.state["line".concat(i)]; //this.refs.chart.chartInstance.update()
    });
...
//# sourceMappingURL=index.js.427603bd5ebd7babf345.hot-update.js.map