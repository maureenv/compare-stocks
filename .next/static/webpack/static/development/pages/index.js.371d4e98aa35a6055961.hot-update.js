...
})([".input{position:relative;z-index:-9999;}.input:checked + label{background:black;}.label{background:gray;color:#fff;padding:5px;font-family:'Roboto',sans-serif;cursor:pointer;font-size:13px;border-radius:4px;width:50px;}"]);
...
//# sourceMappingURL=index.js.371d4e98aa35a6055961.hot-update.js.map