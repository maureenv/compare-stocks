  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "chartData", function (canvas) {
      ...
      if (stocks.length) {
        ...
        gradient.addColorStop(0, 'rgba(141,255,103,0)');
        gradient.addColorStop(1, 'rgba(103,255,255,0.3)');
...
//# sourceMappingURL=index.js.84541d874dfeba0c0ef6.hot-update.js.map