...
var InfoIcon = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].img.withConfig({
...
var RowHeader = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
...
})([".input{opacity:0;}.input:checked + label{background:", ";}.label{background:", ";color:#fff;padding:5px;font-family:'Roboto',sans-serif;cursor:pointer;font-size:13px;border-radius:4px;width:30px;text-align:center;display:inline-block;}.input[type=\"checkbox\"]:focus + label::before{outline:rgb(59,153,252) auto 5px;}"], function (props) {
...
//# sourceMappingURL=index.js.d8ab02169d2134bd4305.hot-update.js.map