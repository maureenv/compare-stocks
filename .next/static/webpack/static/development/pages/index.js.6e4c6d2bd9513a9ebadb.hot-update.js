  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setSymbol", function (index, e, clickedItem) {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var selected, symbolList;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (clickedItem === "input") {
                  selected = e.target.value; // const res = await fetch(`https://www.alphavantage.co/query?function=SYMBOL_SEARCH&keywords=${ selected }&apikey=KT28GNBJ2ECP4SJ1`)
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submit", function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var symbolList, removeFromList, filteredList, res, _data, stocks, array;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                stocks = [];
                array = Object.keys(_data).map(function (d) {
                  return stocks.push(_data[d]);
                });
...
//# sourceMappingURL=index.js.6e4c6d2bd9513a9ebadb.hot-update.js.map