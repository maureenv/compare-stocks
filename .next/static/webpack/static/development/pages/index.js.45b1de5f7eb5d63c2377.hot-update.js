  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTableRow", function (title, category, subcategory, isDollar, isPercent) {
      ...
      var info = descriptions.filter(function (d) {
        console.log(Object.keys(d), 'the key');

        if (Object.keys(d) === subcategory) {
          console.log(subcategory, 'subcategory matches');
        }
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tr, {
        __source: {
...
//# sourceMappingURL=index.js.45b1de5f7eb5d63c2377.hot-update.js.map