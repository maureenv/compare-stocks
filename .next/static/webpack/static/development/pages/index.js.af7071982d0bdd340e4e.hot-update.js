...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clearMatches", function (e) {
      var clicked = e.target.getAttribute('class');
      console.log(clicked, 'the clicked thing');

      if (clicked !== 'symbol' && clicked !== 'match') {
        var _loop = function _loop(i) {
          _this.setState(_defineProperty({}, "matches".concat(i), null), function () {
            return console.log(_this.state["matches".concat(i)], 'should be null');
          });
        };
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      document.body.addEventListener('onKeyPress', this.clearMatches);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.af7071982d0bdd340e4e.hot-update.js.map