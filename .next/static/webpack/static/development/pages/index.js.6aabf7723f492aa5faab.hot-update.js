  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submit", function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var symbolList, removeFromList, filteredList, res, data, stocks, array, chartItemVisible;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                if (stocks.length > 0) {
                  chartItemVisible = [];
                  stocks.map(function (s, i) {
                    return chartItemVisible.push(false);
                  });

                  _this.setState({
                    stocks: stocks,
                    chartItemVisible: chartItemVisible
                  });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleLine", function (i) {
      console.log(_this.state, 'the state');
      console.log(_this.state.chartItemVisible[i], 'is visible?'); //  console.log( this.state[`line${ i }`], 'the toggled state')

      _this.setState(function (prevState) {
        return {
          chartItemVisible: !prevState.chartItemVisible[i]
        };
      }, function () {
        return console.log(_this.state.chartItemVisible[i], 'after state change');
      });

      console.log(_this.state["line".concat(i)], 'the toggled state');
      _this.refs.chart.chartInstance.getDatasetMeta(i).hidden = _this.state.chartItemVisible[i];
...
//# sourceMappingURL=index.js.6aabf7723f492aa5faab.hot-update.js.map