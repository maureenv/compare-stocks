...
function (_Component) {
  ...
  function Index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "buildChartData", function (stocks) {
      ...
      var labels = [];
      stocks.length && stocks.chart.map(function (c) {
        return labels.push(c.date);
      });
      console.log(labels, 'the labels'); // chartData.labels = dates
...
//# sourceMappingURL=index.js.21cc4d684302131b058d.hot-update.js.map