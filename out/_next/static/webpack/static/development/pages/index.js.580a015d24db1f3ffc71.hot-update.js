...
})(["position:relative;.input{font-size:15px;padding:5px;border:none;background:none;border-bottom:", ";color:#fff;font-weight:700;text-align:right;width:100px;transition:all 0.2s ease-in-out;::-webkit-input-placeholder{color:#fff;}::-moz-placeholder{color:#fff}:-ms-input-placeholder{color:#fff;}:-moz-placeholder{color:#fff;}}"], function (props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderInputFields", function () {
      ...
      return Array.from(new Array(4), function (val, i) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Th, {
          ...
          value: symbolList[i] || '',
          hasValue: symbolList[i] && symbolList[i].length > 0 ? true : false,
...
//# sourceMappingURL=index.js.580a015d24db1f3ffc71.hot-update.js.map