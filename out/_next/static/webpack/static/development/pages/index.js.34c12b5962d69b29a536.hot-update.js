...
})(["position:relative;.input{font-size:13px;padding:5px;border:none;background:none;border-bottom:1px solid #fff;color:#fff;font-weight:700;text-align:right;width:90px;transition:all 0.2s ease-in-out;&:hover{width:100%;}::-webkit-input-placeholder{color:#6f6f6f;}::-moz-placeholder{color:#6f6f6f;}:-ms-input-placeholder{color:#6f6f6f;}:-moz-placeholder{color:#6f6f6f;}}"]);
...
//# sourceMappingURL=index.js.34c12b5962d69b29a536.hot-update.js.map